...
const SQUANDER_TABLES = {
  ...
  'from-the-north': {
    glory: [
      { title: "The First Horn", text: "You meant only to drink. One horn became three. By midnight you were standing on a table teaching southerners the proper way to sing a death-song. Nobody died. Somehow that felt disappointing.", boons: "" },
      { title: "Broken Benches", text: "A dockworker laughed at your accent. You threw him across two tables hard enough to break both. His friends backed away. The hall bought your drinks after that. Nobody wanted your temper pointed at them next.", boons: "" },
      { title: "Snow-Blooded", text: "A hard-eyed northern woman with frost scars on her shoulders drank beside you until the room blurred with smoke and heat. You wrestled in the snow behind the hall while the crowd shouted wagers from the doorway. You lost track of your coin long before dawn.", boons: "" },
      { title: "The Old Tongue", text: "Someone began an old marching song from the north. You answered without thinking. Soon half the hall was roaring verses about dead kings and burned forts while civilized folk stared in nervous silence. Men clasped your shoulders like long-lost kin.", boons: "Gain a northern contact." },
      { title: "The Firepit", text: "You drank with caravan guards around a roaring fire until stories turned into boasts and boasts turned into wrestling matches in the ashes. By dawn your arm was burned, your purse was lighter, and your name had spread through every camp outside the walls.", boons: "" },
      { title: "Venarium", text: "A drunken officer mocked the fall of Venarium to impress a girl. The next moments vanished into fury. Tankards shattered. Teeth flew. When the watch finally arrived the officer was unconscious beneath a ruined table and northerners across the hall were chanting your name.", boons: "Recover 1 plunder." },
      { title: "The Wolf-Howl", text: "You led a pack of drunken northerners through the streets after midnight howling battle cries at the moon. Dogs barked. Windows slammed shut. Somewhere during the chaos you overturned a merchant's cart and handed out his goods like a victorious king dividing spoils.", boons: "" },
      { title: "Blood-Brothers", text: "A knife fight behind the alehouse ended with both of you bleeding into the snow and laughing like madmen. Instead of finishing each other, you shared a skin of black liquor and swore friendship over the blood freezing on your hands.", boons: "Gain a warrior contact." },
      { title: "The Mead-Hall", text: "Someone brought you to a hidden northern hall beyond the city walls where exiles, raiders, and sellswords feasted beneath hanging shields. The drinking lasted two days. You remember drums, firelight, and waking with three new scars and twice as many friends.", boons: "Gain 2 northern contacts." },
      { title: "The Bear Shirt", text: "You stripped to the waist and fought six men in a frenzy after someone challenged your courage. Chairs splintered. One man lost an ear. Another kissed your forehead afterward and called you touched by war spirits.", boons: "" },
      { title: "The Jarl's Son", text: "A northern noble traveling in disguise watched you throw a watchman through a window and laugh in the face of drawn steel. Delighted, he drank with you until sunrise and gifted you a heavy silver arm-ring before disappearing into the dawn.", boons: "Gain 1 treasure." },
      { title: "The Red Feast", text: "A feast among northerners turned savage as old rivalries surfaced. You stood atop the table roaring challenges while men traded blows around you. By night's end three grudges were settled, two romances begun, and your purse entirely gone.", boons: "" },
      { title: "Axes at Midnight", text: "What began as drinking became a midnight contest in the frozen yard behind the hall — axe throwing at increasingly dangerous targets. By the final throw men were standing against the boards laughing nervously while you split thrown apples from their heads.", boons: "Gain permanent reputation among northerners here." },
      { title: "The Storm-Ride", text: "Drunk beyond reason, you and a band of northmen stole horses and rode into the winter hills during a blizzard simply because someone claimed it couldn't be done. You returned half frozen at dawn singing louder than before.", boons: "Recover 2 plunder." },
      { title: "The Hall-Singer", text: "A wandering skald followed your rampage from hall to hall recording every boast, fight, and broken door. By sunrise he was already performing the tale to cheering crowds — badly exaggerated, but glorious all the same.", boons: "Gain a skald contact." },
      { title: "The Long Night", text: "The rampage consumed three straight nights. Alehouses barred their doors when they heard you were near. Men joined your wake through the city simply to witness what would happen next. Somewhere during it all you acquired a fine horse, a jeweled torque, and a black eye you cannot explain.", boons: "Gain 1 treasure + gain a horse." },
      { title: "The War-Dream", text: "You drank yourself into the old battle-fury. Witnesses swear you fought ten men with a burning branch torn from the hearth while screaming the names of forgotten kings. Northerners now greet you with equal parts admiration and fear.", boons: "Gain fearsome northern reputation." },
      { title: "The Night the City Trembled", text: "Your rampage spread through the district like fire through dry grass. Halls shattered. Watch patrols scattered. Northern war songs echoed from the rooftops until dawn painted the snow red. Somewhere in the chaos you vanished into legend. By morning everyone had a different story about what you did — and every version sounded impossible.", boons: "Gain 1 treasure + permanent reputation in this city." }
    ],
    chaos: [
      { title: "Sour Ale", text: "You sought glory and found only weak drink, weak songs, and weak men. You spent heavily trying to force life into the night but even drunkenness refused to come properly.", boons: "" },
      { title: "The Wrong Northman", text: "You challenged a scarred giant from Nordheim to a wrestling match after mocking his beard. He beat you unconscious in front of the entire hall and drank from your purse while you snored beneath the table.", boons: "Lose 7 HP." },
      { title: "Black Drink", text: "Someone handed you a horn of black northern liquor strong enough to melt memory itself. The rest of the night exists only as flashes — blood on snow, screaming laughter, shattered doors. You woke missing coin, weapons, and good sense.", boons: "" },
      { title: "The Feud Begins", text: "You insulted a clan-name without understanding its history. Silence fell across the hall. Steel came out slowly after that. The matter is no longer about you alone.", boons: "Gain a northern enemy." },
      { title: "Frostbite", text: "You wandered half naked into the winter streets roaring battle songs at the moon. They found you buried in snow outside the walls at dawn with blackened fingers and an empty purse.", boons: "Lose 1 extra plunder." },
      { title: "The Burning Hall", text: "During a brawl someone overturned the firepit. Maybe you. Maybe not. By the time anyone reacted flames were climbing the walls. You escaped through smoke and splintered timber while angry northerners shouted your description behind you.", boons: "" },
      { title: "Wolf-Eyes", text: "You flew into such a savage rage during a tavern fight that even your companions backed away. The silence afterward was worse than the violence. People look at you differently now.", boons: "Gain a fearsome reputation." },
      { title: "The Blood-Oath", text: "Deep in your cups, you swore an oath over drawn steel to aid a man whose face you barely remember. Unfortunately, everyone else remembers it perfectly.", boons: "Gain a dangerous obligation (GM's choice)." },
      { title: "Ice River", text: "A duel spilled out onto a frozen river beyond the walls. The ice cracked beneath both of you as you fought. He crawled away bleeding. You barely crawled away at all.", boons: "Lose 12 HP." },
      { title: "The Wolf-Pack", text: "You led drunken northmen through the streets smashing market stalls and overturning carts until the city watch descended in force. The escape scattered your companions and cost you everything in your purse.", boons: "Gain a watch enemy." },
      { title: "The Long Shame", text: "You awoke in a stable wearing someone else's cloak, someone else's boots, and a marriage bracelet tied around your wrist. Nobody present would explain what happened. Their expressions suggested disaster.", boons: "" },
      { title: "The Axe-Throw", text: "An axe contest turned ugly when someone moved during the throw. The screaming lasted longer than the drinking afterward. You fled before dawn with blood still drying on your hands.", boons: "Gain an enemy family." },
      { title: "The Snow Hunt", text: "You joined drunken hunters chasing something through the forest at night. Men vanished one by one into the trees. Whatever followed you back from the dark still appears in your dreams.", boons: "Gain a mystic contact." },
      { title: "Chain and Oar", text: "You woke chained to an oar aboard a northern raider ship already miles from shore. Apparently you volunteered after boasting you feared neither sea nor whip. Escaping cost you dearly.", boons: "Gain a ship captain enemy + lose 1 plunder." },
      { title: "The Watch Cells", text: "The city watch finally cornered you after a night of destruction that left half a district awake and furious. The beating was slow and methodical. The bribe afterward emptied what little wealth survived the rampage.", boons: "Gain a watch contact. Lose 4 HP." },
      { title: "The Red Snow", text: "A hall feud erupted into open slaughter. Men hacked each other apart in the streets while snow drank the blood beneath torchlight. You survived by becoming more savage than everyone around you.", boons: "Gain a scar + gain a violent reputation." },
      { title: "The Wolf-Brand", text: "Raiders and killers welcomed you into their fire after witnessing your fury firsthand. They carved their wolf-mark into your flesh while you drank with them beneath the winter stars. Now dangerous people call you brother.", boons: "Gain outlaw contact + criminal reputation." },
      { title: "The Night of Rampage", text: "Something broke loose inside you and took the whole district with it. The night became fire, blood, smashed gates, war songs, and running battles through the snow-choked streets. By dawn the city looked raided by barbarians. Perhaps it was. Somewhere in the madness you claimed treasure from the dead — and earned the hatred of someone powerful enough to remember your name forever.", boons: "Gain 1 treasure + a powerful enemy + a permanent scar. Roll 2d6 — you have that many HP remaining." }
    ]
  },
  'from-the-wilds': {
    glory: [
      { title: "Rain on Bare Skin", text: "Warm rain hissed upon the jungle fires while you drank raw spirits from a skull-cup beside painted hunters. A lithe girl with tiger-teeth braided in her black hair pulled you laughing into the reeds. You woke at dawn naked beneath the steaming trees with her bite-marks on your shoulder and no clear memory of where your silver had gone.", text_f: "Warm rain hissed upon the jungle fires while you drank raw spirits from a skull-cup beside painted hunters. A lean hunter with tiger-teeth braided in his black hair pulled you laughing into the reeds. You woke at dawn naked beneath the steaming trees with his bite-marks on your shoulder and no clear memory of where your silver had gone.", boons: "" },
      { title: "The Black River", text: "Mad with drink and boasting, you plunged into the black river despite the crocodiles gliding beneath the moonlit water. Men shouted wagers from the bank. You came forth dripping with weeds tangled in your hair and a jade arm-ring clenched between your teeth.", boons: "" },
      { title: "Drums in the Night", text: "The drums began at sunset and did not cease. Naked warriors painted in blood and ash leapt roaring about the fires while women with bronze limbs and catlike eyes dragged men into the darkness beyond the torchlight. By dawn your purse was empty and your blood was afire.", boons: "" },
      { title: "The Hunt Feast", text: "You rode with painted hunters beneath a swollen moon and brought down a striped jungle-cat with your bare spear. That night its flesh roasted above the fires while the tribe drank and howled your name to the stars.", boons: "Recover 1 plunder." },
      { title: "Moon-Madness", text: "There was madness in the moon that night. Men snarled over scraps of meat. Women laughed like hunting panthers. You fought three warriors in the mud beside the fire while a raven-haired huntress clung to your back with fierce white teeth buried in your flesh.", boons: "" },
      { title: "The Leopard Woman", title_f: "The Leopard Man", text: "She came from the trees naked save for a girdle of leopard hide and a necklace of human teeth. Her laughter was low and wicked as jungle thunder. You vanished with her into the blackness beyond the fires and returned at dawn bleeding from a dozen pleasant wounds.", text_f: "He came from the trees naked save for a girdle of leopard hide and a necklace of human teeth. His laughter was low and wicked as jungle thunder. You vanished with him into the blackness beyond the fires and returned at dawn bleeding from a dozen pleasant wounds.", boons: "" },
      { title: "The Bone Fires", text: "You squandered silver freely among a hidden forest tribe that painted your limbs red and crowned you with stag antlers beside great fires built from old bones. The drums boomed until the very jungle seemed to sway around you.", boons: "Gain a wilderness contact." },
      { title: "The Crocodile Pit", text: "Drugged on smoke and jungle liquor, you leapt into a crocodile pit armed only with a knife while the tribe shrieked in savage delight overhead. You came forth bloodied, laughing, and dragging the beast's severed tail behind you.", boons: "Gain fearsome reputation among wild folk nearby." },
      { title: "The Fever Dance", text: "Sweat gleamed upon writhing bodies around the fire while drums hammered like a racing heart through the steaming dark. You danced until your sight blurred red and gold and strange hands dragged you down among the furs beside the flames.", boons: "" },
      { title: "The White Ape", text: "You hunted a monstrous white ape through vine-choked ruins beneath the moon. It slew two men before your spear took it through the throat. That night the tribe feasted upon roasted meat and strong drink while women painted your chest with victory signs in crimson dye.", boons: "Gain a hunter contact." },
      { title: "The Red Marsh", text: "You vanished into the steaming marshes with a painted huntress whose eyes gleamed green in the moonlight. For two days no man saw you. When you returned your purse was gone, your body was scarred, and your grin was wild as a wolf's.", text_f: "You vanished into the steaming marshes with a painted hunter whose eyes gleamed green in the moonlight. For two days no man saw you. When you returned your purse was gone, your body was scarred, and your grin was wild as a wolf's.", boons: "" },
      { title: "The Great Beast", text: "The drums called the hunters together beneath a red moon and you rode with them into the black jungle after something huge and ancient. Men died screaming beneath claw and fang before the beast finally fell beneath a storm of spears.", boons: "Gain 1 treasure." },
      { title: "The Mating Fires", text: "The tribe built towering fires that sent sparks whirling into the hot night sky while men and women alike gave themselves over to wine, flesh, and savage revels. You squandered silver like a drunken king and woke tangled among warm bodies beneath panther skins.", boons: "" },
      { title: "The Wild Bride", title_f: "The Wild Groom", text: "A chieftain's daughter painted in blue woad chose you before the whole tribe and led you by the wrist into her father's lodge while drums thundered beyond the hide walls. The old chief laughed until tears ran down his scarred cheeks.", text_f: "A chieftain's son painted in blue woad chose you before the whole tribe and led you by the wrist into his father's lodge while drums thundered beyond the hide walls. The old chief laughed until tears ran down his scarred cheeks.", boons: "Gain a tribal refuge." },
      { title: "The Jungle Storm", text: "Lightning split the heavens while naked hunters raced roaring through the rain with torches blazing in their fists. You ran with them half-mad beneath the storm, hunted by thunder and drunk on life itself.", boons: "Recover 2 plunder." },
      { title: "The Beast Within", text: "There are whispers now among the wild folk that some old jungle spirit walks beside you. Men leave meat by your fire. Women smile with dangerous hunger when you pass. Even the hunting cats do not flee your scent.", boons: "Gain permanent wilderness reputation." },
      { title: "The Frenzy", text: "The red moon rose above the black jungle and the frenzy took the tribe like fire through dry reeds. Men howled. Women danced naked beside the flames. Blood ran hot in the mud while drums boomed like the heartbeat of the earth itself. You hunted, fought, drank, and coupled until dawn found you standing among shattered bodies and dying fires with the jungle steaming around you like some vast breathing beast.", boons: "Gain 1 treasure + gain a passionate lover contact." },
      { title: "The Night of Tooth and Claw", text: "Long afterward men still spoke in whispers of that night beneath the swollen moon when the wild folk gave themselves wholly to blood, lust, and slaughter. Fires reddened the jungle sky for miles. Great beasts prowled openly beside painted hunters. You strode through it all like something born before civilization itself, terrible and magnificent beneath the torchlight.", boons: "Gain 1 treasure + permanent reputation among wild folk." }
    ],
    chaos: [
      { title: "Rot-Gut", text: "The liquor was sour, the meat half-spoiled, and the jungle heavy with foul vapors. You spent silver freely seeking pleasure but found only sweat, insects, and ill temper.", boons: "" },
      { title: "Snake-Bitten", text: "Drunk on raw spirits, you staggered barefoot into the reeds after a laughing girl whose face you never clearly saw. The viper struck before you reached her. You woke with your leg split open by a healer's knife and fever burning in your skull.", text_f: "Drunk on raw spirits, you staggered barefoot into the reeds after a laughing hunter whose face you never clearly saw. The viper struck before you reached him. You woke with your leg split open by a healer's knife and fever burning in your skull.", boons: "Lose 7 HP." },
      { title: "Lost in the Green Hell", text: "Something savage seized your blood beneath the moon. You vanished into the jungle for two days with no memory of where you wandered. You returned gaunt, mud-caked, and minus every coin you carried.", boons: "" },
      { title: "The Rival", text: "You fought a painted hunter over a bronze-limbed woman beside the fire while the tribe roared wagers around you. He split your scalp with a stone-headed club before you broke his jaw and drove him snarling into the dark.", text_f: "You fought a painted huntress over a bronze-limbed man beside the fire while the tribe roared wagers around you. She split your scalp with a stone-headed club before you broke her jaw and drove her snarling into the dark.", boons: "" },
      { title: "Bad Moon", text: "There was evil in the moon that night. Men quarreled over nothing. Lovers clawed each other bloody beside the fires. You woke with dried blood beneath your fingernails and no memory of whose throat you had gripped.", boons: "Lose 1 extra plunder." },
      { title: "Crocodile Water", text: "You plunged laughing into dark river water thick with moon-glitter and woke screaming as crocodile jaws closed upon your ribs. The scars will remain long after the memory fades.", boons: "Lose 12 HP." },
      { title: "The Painted Rite", text: "Drugged on strange smoke, you joined a midnight rite beneath towering trees where naked figures painted in ash danced around a stone altar slick with old blood. At dawn you found fresh ritual scars cut into your chest.", boons: "Gain a mystic contact." },
      { title: "The Hunt Turns", text: "You rode with hunters beneath the moon pursuing something huge through the jungle. Before midnight the hunters themselves were fleeing in panic while something vast crashed through the trees behind them.", boons: "Lose half HP." },
      { title: "The Panther Woman", title_f: "The Panther Man", text: "She laughed like a hunting cat and loved with equal savagery. By dawn your back was striped with claw-marks, your purse empty, and your pride in tatters.", text_f: "He laughed like a hunting cat and loved with equal savagery. By dawn your back was striped with claw-marks, your purse empty, and your pride in tatters.", boons: "" },
      { title: "The Stampede", text: "Drums and fire sent a herd of aurochs thundering madly through the camp. Men were trampled screaming beneath black hooves while burning tents collapsed into showers of sparks around you.", boons: "Gain a scar." },
      { title: "The Bone Pit", text: "You woke naked at the bottom of a ritual pit filled with old bones, broken idols, and sleeping strangers painted head to toe in red clay. Nobody would tell you what occurred there.", boons: "" },
      { title: "The Tribe's Wrath", text: "In your drunken frenzy you violated some ancient custom of the wild folk. At spearpoint they drove you naked into the jungle while drums thundered angrily behind you through the night.", boons: "Gain a tribal enemy." },
      { title: "Swamp Fever", text: "The steaming marshes bred fever into your blood after nights spent drunk, wounded, and sprawled beside filthy waters. You burned silver desperately on herbs, smoke cures, and half-mad healers.", boons: "Lose 4 HP." },
      { title: "The Thing in the Trees", text: "Something followed you back from the jungle after the hunt. You never saw more than blazing eyes and black fur among the leaves, but beasts whimper and pull against their ropes whenever night falls now.", boons: "Gain a hunter contact." },
      { title: "Blood in the Mud", text: "The frenzy became violence before midnight. Men grappled half naked in the mud while women shrieked encouragement beside the roaring fires. You woke bruised, blood-smeared, and clutching a knife that was not yours.", boons: "Gain a dangerous lover contact." },
      { title: "The Wild Hunt", text: "Painted hunters swept through the jungle beneath the red moon pursuing prey that screamed like a man and fought like a demon. By dawn half the hunters were dead and the survivors looked upon you with fearful respect.", boons: "Gain outlaw wilderness reputation." },
      { title: "The Beast Mark", text: "Something old and savage moved through the camp that night. Men bit and clawed one another like beasts beside the fires while drums hammered without cease. At dawn strange marks had appeared upon your flesh that no washing can remove.", boons: "Gain a permanent scar + mystic reputation." },
      { title: "The Night of the Red Moon", text: "The frenzy swept the wild folk like madness sent from the black heavens themselves. Fires raged through the jungle. Painted warriors hunted screaming through the dark beside great shadowy beasts. Blood, lust, and slaughter mingled beneath the crimson moon until the earth itself seemed drunk on violence. You survived the night, but some savage part of your soul never truly returned from the jungle.", boons: "Gain 1 treasure + a dangerous enemy + a permanent scar. Roll 2d6 — you have that many HP remaining." }
    ]
  },
  'from-a-civilized-land': {
    glory: [
      { title: "Perfumed Wine", text: "You spent the evening in a lamp-lit pleasure house where dark-eyed girls poured perfumed wine into silver cups while musicians played softly behind silk curtains. The air was heavy with lotus smoke and dangerous laughter. You woke late the next afternoon with your purse lighter and your senses pleasantly dulled.", text_f: "You spent the evening in a lamp-lit pleasure house where dark-eyed youths poured perfumed wine into silver cups while musicians played softly behind silk curtains. The air was heavy with lotus smoke and dangerous laughter. You woke late the next afternoon with your purse lighter and your senses pleasantly dulled.", boons: "" },
      { title: "The Silk Balcony", text: "A noblewoman with crimson lips and eyes darkened by kohl beckoned you onto her moonlit balcony high above the sleeping streets. You drank spiced wine from her mouth while soft curtains stirred in the warm night wind. Her servants pretended not to notice you leaving at dawn.", text_f: "A nobleman with kohl-darkened eyes and a silver-threaded tunic beckoned you onto his moonlit balcony high above the sleeping streets. You drank spiced wine from his mouth while soft curtains stirred in the warm night wind. His servants pretended not to notice you leaving at dawn.", boons: "" },
      { title: "The Lotus Dream", text: "You purchased black lotus from a Stygian with gold rings in his ears and vanished into velvet cushions beneath hanging lanterns while the smoke carried your thoughts into strange and pleasant places. When you woke, strange women lay sleeping beside you and half your silver was gone.", text_f: "You purchased black lotus from a Stygian with gold rings in his ears and vanished into velvet cushions beneath hanging lanterns while the smoke carried your thoughts into strange and pleasant places. When you woke, strange men lay sleeping beside you and half your silver was gone.", boons: "" },
      { title: "The Veiled Girl", title_f: "The Veiled Youth", text: "A veiled dancer with anklets of gold and eyes like midnight drew you into hidden chambers behind a wine-house known only to the wealthy and corrupt. Her laughter was low and wicked as poison in a king's cup. You spent lavishly and regretted nothing.", text_f: "A veiled dancer with anklets of gold and eyes like midnight drew you into hidden chambers behind a wine-house known only to the wealthy and corrupt. His laughter was low and wicked as poison in a king's cup. You spent lavishly and regretted nothing.", boons: "" },
      { title: "The Scholar's Table", text: "You drank wine thick as blood with poets, alchemists, and minor nobles while candlelight flickered across forbidden scrolls and maps of ruined cities. By night's end you had purchased secrets no honest man would dare speak aloud.", boons: "Gain a scholar contact." },
      { title: "The House of Blue Silk", text: "You squandered silver freely in a pleasure house whose walls were draped in blue silk and whose women moved like sleek hunting cats beneath incense smoke. Somewhere during the revel a Zamorian thief relieved you of your jewels and kissed you while doing so.", text_f: "You squandered silver freely in a pleasure house whose walls were draped in blue silk and whose men moved like sleek hunting cats beneath incense smoke. Somewhere during the revel a Zamorian thief relieved you of your jewels and kissed you while doing so.", boons: "" },
      { title: "The Wine Garden", text: "Moonlight gleamed on marble fountains while perfumed courtesans reclined upon cushions amid flowering vines. You spent the night in languid conversation, dangerous flirtation, and slow intoxication beneath the stars.", text_f: "Moonlight gleamed on marble fountains while perfumed paramours reclined upon cushions amid flowering vines. You spent the night in languid conversation, dangerous flirtation, and slow intoxication beneath the stars.", boons: "" },
      { title: "The Alchemist's Daughter", title_f: "The Alchemist's Son", text: "The daughter of a wealthy alchemist entertained you among crystal vials and strange scented vapors that clouded the senses delightfully. Her pale fingers traced symbols upon your bare chest while somewhere nearby forbidden brews simmered over green fire.", text_f: "The son of a wealthy alchemist entertained you among crystal vials and strange scented vapors that clouded the senses delightfully. His pale fingers traced symbols upon your bare chest while somewhere nearby forbidden brews simmered over green fire.", boons: "Gain an alchemist contact." },
      { title: "The Hidden Salon", text: "Behind a false wall in a respectable merchant's manor lay a hidden salon where masked nobles indulged every appetite civilized men pretend not to possess. You drank black wine beside senators, poisoners, and half-clad dancers while musicians played soft and decadent melodies until dawn.", boons: "Gain a noble contact." },
      { title: "The Temple Courtesan", text: "A priestess of Ishtar with heavy-lidded eyes and bronze limbs summoned you to her perfumed chambers high within the temple walls. The rites she taught you were old when the kingdoms were young.", text_f: "A priest of Ishtar with heavy-lidded eyes and bronze limbs summoned you to his perfumed chambers high within the temple walls. The rites he taught you were old when the kingdoms were young.", boons: "" },
      { title: "The Sapphire Feast", text: "You attended a feast where jeweled goblets overflowed with honeyed wine and drugged fruits gleamed upon silver trays beneath hanging lamps of colored glass. Before the night ended you found yourself tangled among silk cushions beside two laughing noblewomen who smelled of myrrh and lotus.", text_f: "You attended a feast where jeweled goblets overflowed with honeyed wine and drugged fruits gleamed upon silver trays beneath hanging lamps of colored glass. Before the night ended you found yourself tangled among silk cushions beside two laughing noblemen who smelled of myrrh and lotus.", boons: "Recover 1 plunder." },
      { title: "The Red Pavilion", text: "Behind crimson curtains in the Maul you discovered a hidden den where gladiators, nobles, and courtesans reveled together beneath torchlight thick with narcotic smoke. By dawn you had fought a duelist, seduced a merchant's wife, and misplaced a purse heavy with silver.", text_f: "Behind crimson curtains in the Maul you discovered a hidden den where gladiators, nobles, and paramours reveled together beneath torchlight thick with narcotic smoke. By dawn you had fought a duelist, seduced a merchant's husband, and misplaced a purse heavy with silver.", boons: "" },
      { title: "The Forbidden Library", text: "A silk-robed scholar guided you through hidden archives sealed beneath an old temple where dust lay thick upon scrolls forbidden by kings. You emerged at sunrise drunk on wine, knowledge, and possibilities.", boons: "Gain a forbidden lore contact." },
      { title: "The Lotus Revel", text: "You surrendered wholly to lotus dreams in chambers lit by purple lamps while naked dancers moved like spirits through clouds of scented smoke. Hours—or perhaps days—slipped by unnoticed while servants quietly carried away the last of your coin.", boons: "Recover 2 plunder." },
      { title: "The Noble Widow", title_f: "The Noble Widower", text: "A wealthy widow draped in translucent silk took a dangerous liking to you after hearing you speak of lost kingdoms and forbidden places. Three days vanished in wine, flesh, and whispered conspiracies within her marble villa.", text_f: "A wealthy widower draped in dark silks took a dangerous liking to you after hearing you speak of lost kingdoms and forbidden places. Three days vanished in wine, flesh, and whispered conspiracies within his marble villa.", boons: "Gain 1 treasure." },
      { title: "The Black Banquet", text: "You supped with masked aristocrats in a candlelit chamber beneath the city where every goblet might contain poison and every smile concealed blackmail. Yet the wine was exquisite and the company even more so.", boons: "Gain a courtly intrigue contact." },
      { title: "The Perfumed Labyrinth", text: "Your indulgence carried you from silk-draped manors to hidden lotus dens to moonlit rooftops where perfumed lovers waited among cushions and wine jars. By the final dawn your name passed through the city's decadent circles like delicious scandal.", boons: "Gain permanent reputation among decadent society." },
      { title: "The Night of Indulgence", text: "The city opened itself before you like a jeweled courtesan. Silk rustled in torchlit chambers. Lotus smoke drifted through hidden halls where naked dancers writhed to soft music and dangerous nobles whispered of forbidden things. You drank rare wines from jeweled cups, squandered silver like a prince, and vanished into perfumed darkness beside lips red as fresh blood. When dawn finally crept over the marble towers, half the city envied you and the other half feared what secrets you now possessed.", boons: "Gain 1 treasure + permanent reputation in this city." }
    ],
    chaos: [
      { title: "Weak Wine", text: "You spent heavily seeking pleasure among the city's revels and found only thin wine, dull company, and stale lotus smoke. Even the courtesans seemed bored of themselves.", text_f: "You spent heavily seeking pleasure among the city's revels and found only thin wine, dull company, and stale lotus smoke. Even the paramours seemed bored of themselves.", boons: "" },
      { title: "Drugged", text: "A dark-eyed beauty fed you lotus from her fingertips while musicians played softly behind silk curtains. You woke at noon in an unfamiliar chamber with your purse gone and only vague memories of laughter and crimson lips.", text_f: "A dark-eyed youth fed you lotus from his fingertips while musicians played softly behind silk curtains. You woke at noon in an unfamiliar chamber with your purse gone and only vague memories of laughter and a wicked grin.", boons: "Lose 1 extra plunder." },
      { title: "The Poison Kiss", text: "You offended a jealous noble without realizing it until a courtesan pressed her painted mouth against yours and whispered a warning between kisses. The poison was slow but painful. The antidote cost dearly.", text_f: "You offended a jealous noble without realizing it until a paramour pressed his painted mouth against yours and whispered a warning between kisses. The poison was slow but painful. The antidote cost dearly.", boons: "Lose 7 HP." },
      { title: "The Velvet Trap", text: "You became entangled with a merchant's wife whose appetites exceeded even her husband's wealth. The affair ended with guards hammering at the door while you escaped half naked across moonlit rooftops clutching your boots and little else.", text_f: "You became entangled with a merchant's husband whose appetites exceeded even his wife's wealth. The affair ended with guards hammering at the door while you escaped half naked across moonlit rooftops clutching your boots and little else.", boons: "" },
      { title: "The Black Lotus", text: "You indulged too deeply in black lotus and vanished into delirious dreams while thieves quietly emptied your purse and jewel belt beside you. When you finally staggered awake, two days had passed.", boons: "" },
      { title: "The Silk Scandal", text: "A pleasure house servant recognized you leaving the chambers of someone powerful and dangerous. By sunset whispers had already begun spreading through the city's darker circles.", boons: "Gain a scandalous reputation." },
      { title: "The Jeweled Dagger", text: "You quarreled with a perfumed duelist over a courtesan whose smile encouraged violence. Steel flashed beneath hanging lanterns while musicians continued playing softly nearby. His jeweled dagger opened your ribs before you finally put him down.", text_f: "You quarreled with a perfumed duelist over a paramour whose smile encouraged violence. Steel flashed beneath hanging lanterns while musicians continued playing softly nearby. Her jeweled dagger opened your ribs before you finally put her down.", boons: "Lose 12 HP." },
      { title: "The Opium Dream", text: "Drugged senseless upon perfumed cushions, you spoke far too freely about matters best kept hidden. By morning several dangerous people knew secrets they should never have heard.", boons: "Gain a blackmail enemy." },
      { title: "The Hidden Cult", text: "The revel beneath the merchant villa became stranger as the night deepened. Masks appeared. Prayers were whispered in forgotten tongues. Only at dawn did you realize the gathering had not merely been decadent—but sacrilegious.", boons: "Gain a cult contact." },
      { title: "The Courtesan's Price", title_f: "The Paramour's Price", text: "A magnificent courtesan with emerald perfume and cold serpent eyes drained your purse over three glorious nights before vanishing entirely. Months later you still dream about her.", text_f: "A magnificent paramour with emerald perfume and cold serpent eyes drained your purse over three glorious nights before vanishing entirely. Months later you still dream about him.", boons: "" },
      { title: "The Noble's Wrath", text: "You were discovered in the chambers of a noble's favored lover while incense still curled through the air around your tangled sheets. Escaping the manor required bribery, bloodshed, and an expensive silence.", boons: "Gain a noble enemy." },
      { title: "The Lotus Fever", text: "Too much black lotus left your mind reeling for days afterward. You wandered the city's moonlit streets half delirious, spending coin recklessly on pleasures and visions you barely remember now.", boons: "Lose 4 HP." },
      { title: "The Silk Noose", text: "A smiling aristocrat invited you to a private feast where every guest concealed a dagger beneath their silks. By night's end someone lay dead beside the fountains and the watch wished to question you urgently.", boons: "Gain a watch enemy." },
      { title: "The Crimson Chamber", text: "You woke in crimson sheets beside a sleeping beauty and a murdered man cooling on the marble floor nearby. Unfortunately, the dead man was important.", text_f: "You woke in crimson sheets beside a sleeping lover and a murdered woman cooling on the marble floor nearby. Unfortunately, the dead woman was important.", boons: "Gain a powerful enemy." },
      { title: "The Perfumed Cells", text: "The city watch arrested you after a week-long revel involving narcotics, violence, and several politically connected lovers. Your imprisonment was luxurious by dungeon standards, but ruinously expensive.", boons: "Gain a watch contact. Lose 1 plunder." },
      { title: "The Sapphire Vice", text: "You descended too deeply into the city's hidden pleasures — black lotus, forbidden flesh, velvet chambers where masked revelers whispered obscenities beside silver mirrors. By the end your appetites themselves had become dangerous.", boons: "Gain a dangerous vice." },
      { title: "The Night of Silk and Poison", text: "Wine, lotus smoke, naked flesh, and whispered conspiracies flowed together beneath jeweled lamps until the entire night became one long fever dream of decadence and danger. Somewhere amid the perfumed madness you acquired both a priceless treasure and an enemy clever enough to destroy you slowly.", boons: "Gain 1 treasure + a cunning enemy." },
      { title: "The Scarlet Indulgence", text: "The city devoured you gladly. Perfumed courtesans, drugged feasts, forbidden rites, velvet chambers hidden beneath marble palaces — you surrendered yourself wholly to every exquisite corruption civilization could offer. By dawn the towers gleamed pale beneath the sunrise while somewhere behind silk curtains nobles whispered your name with fascination, lust, and fear.", text_f: "The city devoured you gladly. Perfumed paramours, drugged feasts, forbidden rites, velvet chambers hidden beneath marble palaces — you surrendered yourself wholly to every exquisite corruption civilization could offer. By dawn the towers gleamed pale beneath the sunrise while somewhere behind silk curtains nobles whispered your name with fascination, lust, and fear.", boons: "Gain 1 treasure + permanent decadent reputation + a dangerous enemy. Roll 2d6 — you have that many HP remaining." }
    ]
  }
};
...
export default class ConanActorSheet2 extends ActorSheet {
  ...
  _getOriginData() {
    return {
      ...
      "from-a-civilized-land": {
        ...
        backgroundImage: "bg_civilized.jpg",
  ...
  _getSquanderEntry(originId, side, rollResult) {
    ...
    // Gender-aware overrides: any field with _f suffix replaces the base field for female PCs
    if (this.actor.system.gender === 'f') {
      const result = { ...entry };
      for (const key of Object.keys(entry)) {
        if (key.endsWith('_f')) result[key.slice(0, -2)] = entry[key];
      }
      return result;
    }
    return entry;
